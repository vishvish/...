...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
  TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
    "lan_ip 232 251 ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD}" \
    "wan_ip 234 251 ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD}"\
    #"earthquake 3 0" \
    "pwd 89 211" \
    #"mailcount 9 255" \
    #"cpu 240 136" \
    ...
    #"xkb_layout 125 117" \
    #"date_day 24 255" \
    "date 238 251 ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD}" \
    "time 242 233 ${TMUX_POWERLINE_SEPARATOR_LEFT_BOLD}" \
